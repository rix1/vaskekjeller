...
reservations, atomic conflicts, household limits, ownership, comments, cancellation, schedule overlaps,
and the board's partly free rows, day-strip status, and first-booking hint cookie.
